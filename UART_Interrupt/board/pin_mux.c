...
void BOARD_InitDEBUG_UARTPins(void)
{
    ...
    PORT_SetPinInterruptConfig(BOARD_DEBUG_UART_RX_PORT, BOARD_DEBUG_UART_RX_PIN, kPORT_InterruptFallingEdge);
    ...
    PORT_SetPinInterruptConfig(BOARD_DEBUG_UART_TX_PORT, BOARD_DEBUG_UART_TX_PIN, kPORT_InterruptFallingEdge);
